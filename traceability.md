...
| REQ-0070 | POST /orders congela unitPrice por item (snapshot) | specs/ticket-printing | 1.0 | orders.e2e-spec.ts::create_snapshots_unitprice | backend/src/orders/orders.service.ts (createOrder), prisma/schema.prisma | feat:ticket-printing | ✅ |   |
